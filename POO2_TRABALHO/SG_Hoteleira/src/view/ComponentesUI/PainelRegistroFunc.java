...
public class PainelRegistroFunc extends JPanel {

    private JPanel painel1, painel2, painel3;
    private JButtonModificado btPesquisar, btAtualizar;
    private TextFieldModificado tfSearch;
    private JLabel l1, l2, l3, l4, lbFuncionario; // Criação das labels
    private JTable tabela;

    public PainelRegistroFunc() {
        ...
        lbFuncionario.setBounds(275, 5, 650, 80);
